...
//  MVVM-C
//
//  Created by Luan Arruda on 25/04/24.
//
...
class RegisterView: UIView {
    ...
    private var delegate: RegisterViewDelegate?
    
    public func setDelegate(delegate: RegisterViewDelegate) {
    ...
    private func setUpConstraints() {
        NSLayoutConstraint.activate([
            ...
            self.registerButton.topAnchor.constraint(equalTo: self.passwordTextField.bottomAnchor, constant: 36),
